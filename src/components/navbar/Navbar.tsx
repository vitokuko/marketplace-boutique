...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 w-full fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center justify-between py-3 px-4 lg:px-8 xl:px-12 max-w-screen-xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          {boutique && (
            <div className="hidden sm:flex items-center">
              ...
              <span className="text-gray-900 font-bold text-lg md:text-xl tracking-wide">
                {boutique.nom}
              </span>
            </div>
          )}
          ...
          <li>
            <button
              ...
              className={`text-sm font-medium transition-colors cursor-pointer ${
                activeButton === 'accueil' || activeButton === null
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <div className="relative">
            ...
            {getTotalItems() > 0 && (
              <span className="absolute -top-0.5 -right-0.5 bg-gray-900 text-white text-xs font-bold h-4 w-4 flex items-center justify-center rounded-full">
                {getTotalItems()}
              </span>
            )}
          </div>
          ...
          <ul className="space-y-1">
            <li>
              <button
                ...
                className="block w-full text-left py-2.5 px-3 rounded-lg text-gray-700 hover:bg-gray-50 font-medium"
              >
                Accueil
              </button>
            </li>
